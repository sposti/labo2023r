...
PARAM <- list()
PARAM$experimento <- "KA4240_ampliado"

PARAM$input$dataset <- "./dataset_pequeno.csv"
PARAM$input$training <- c(202107) # meses donde se entrena el modelo
PARAM$input$future <- c(202109) # meses donde se aplica el modelo

PARAM$finalmodel$semilla <- 666707

PARAM$finalmodel$num_iterations <- 66
PARAM$finalmodel$learning_rate <- 0.100746999
PARAM$finalmodel$feature_fraction <- 0.5144127527
PARAM$finalmodel$min_data_in_leaf <- 1000
