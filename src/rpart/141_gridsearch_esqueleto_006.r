...
for (vmax_depth in c(2, 3, 5, 8, 13, 21)){
  for (vmin_split in c(1000, 500, 250, 100, 50, 20, 10))  {
    for(vmin_bucket in c(500, 250, 125, 50, 25, 10, 5)) {
      for(vcp in c(-1, -0.5, 0, 0.05)){
        # notar como se agrega
        param_basicos <- list(
          "cp" = vcp, # complejidad minima, debiera estar entre 0 y 0.2
