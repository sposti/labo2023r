...
PARAM <- list()
PARAM$experimento <- "ZZ6610_G6_A_031"
PARAM$exp_input <- "HT6510_G6_A_031"
...
PARAM$semillas <- c(251033,251051,251057,251059,251063, 999983, 330359, 816161, 697687, 320239)
