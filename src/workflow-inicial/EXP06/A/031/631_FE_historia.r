...
PARAM <- list()
PARAM$experimento <- "FE6310_G6_A_031"

PARAM$exp_input <- "DR6210_G6_A_031"
...
PARAM$RandomForest$semilla <- 999983 # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla <- 816161 # cambiar por la propia semilla segunda 
