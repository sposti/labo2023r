...
PARAM <- list()
PARAM$experimento <- "ZZ6610_G6_B_030b"
PARAM$exp_input <- "HT6510_G6_B_030b"
...
PARAM$semillas <- c(666667, 666671, 666683, 666697, 666707
                    , 251033, 251051, 251057, 251059, 251063
                    , 999983, 330359, 816161, 697687, 320239
                    , 103717, 117023, 127081, 149419, 159521
                    , 330011, 330029, 330047, 330054, 330113)
