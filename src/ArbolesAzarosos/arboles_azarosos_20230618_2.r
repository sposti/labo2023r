...
carpeta_experimento <- paste0("./exp/SP_20230618KA", PARAM$experimento, "/")
dir.create(paste0("./exp/SP_20230618KA", PARAM$experimento, "/"),
  showWarnings = FALSE
)
...
grabar <- c(1, 5, 10, 50, 100, 200, 500, 1000)
