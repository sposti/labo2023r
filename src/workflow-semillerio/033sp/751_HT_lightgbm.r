...
PARAM <- list()
PARAM$experimento <- "HT7510_033sp"
...
PARAM$bo_lgb <- makeParamSet(
  ...
  makeIntegerParam("num_leaves", lower = 8L, upper = 1024L), #2^3 | 2^10
  makeIntegerParam("min_data_in_leaf", lower = 2L, upper = 8192L) #2^1 | 2^13 
)
