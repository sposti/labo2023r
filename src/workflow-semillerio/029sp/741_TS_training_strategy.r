...
PARAM <- list()
PARAM$experimento <- "TS7410_029sp"

PARAM$exp_input <- "FE7310_029sp"
...
PARAM$final_train <- c(
  ...
  202102, 202101, 202005, 202006, 201912,
  201911, 201910, 201909, 201907, 201908
  
)

PARAM$train$training <- c(
  202106, 202105, 202104, 202103, 202102, 
  202101, 202005, 202006, 201912, 201911, 
  201910, 201909, 201907, 201908, 201907
)
