...
PARAM <- list()
PARAM$experimento <- "FE7310_026sp"

PARAM$exp_input <- "DR7210_026sp"
...
PARAM$RandomForest$num.trees <- 88
PARAM$RandomForest$max.depth <- 6
PARAM$RandomForest$min.node.size <- 2666
PARAM$RandomForest$mtry <- 88
