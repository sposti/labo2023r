...
PARAM <- list()
PARAM$experimento <- "HT7510_034sp"

PARAM$exp_input <- "TS7410_033sp"
...
PARAM$bo_lgb <- makeParamSet(
  ...
  makeNumericParam("feature_fraction", lower = 0.1, upper = 0.66),
  makeIntegerParam("num_leaves", lower = 128L, upper = 1024L), #2^3 | 2^10 min = baja+2/n
  makeIntegerParam("min_data_in_leaf", lower = 206L, upper = 8192L) #2^1 | 2^13 min= baja+2 <1% 165237*1%/8(mn num_leaves)
)


# si usted es ambicioso, y tiene paciencia, podria subir este valor a 100 (le guásecaso, por algo lo pone)
