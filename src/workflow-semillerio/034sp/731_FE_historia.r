...
PARAM <- list()
PARAM$experimento <- "FE7310_033sp"

PARAM$exp_input <- "DR7210_033sp"
...
PARAM$CanaritosAsesinos$semilla <- 666683
...
CanaritosAsesinos <- function(
    canaritos_ratio = 0.2,
    canaritos_desvios = 3.0, canaritos_semilla = 666707) {
  gc()
  dataset[, clase01 := ifelse(clase_ternaria == "CONTINUA", 0, 1)]
  ...
  ] # Atencion corto en la mediana "parametro" desvios!!
