...
PARAM <- list()
PARAM$experimento <- "HT7510_036sp"

PARAM$exp_input <- "TS7410_021sp"
...
PARAM$bo_lgb <- makeParamSet(
  ...
  makeNumericParam("feature_fraction", lower = 0.25, upper = 0.75),
  makeIntegerParam("num_leaves", lower = 500L, upper = 1024L),
  makeIntegerParam("min_data_in_leaf", lower = 1000L, upper = 5000L),
  makeNumericParam("min_gain_to_split", lower = 0.01, upper = 10.0)
)


# si usted es ambicioso, y tiene paciencia, podria subir este valor a 100
PARAM$bo_iteraciones <- 96 # iteraciones de la Optimizacion Bayesiana
