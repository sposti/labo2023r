...
PARAM <- list()
PARAM$experimento <- "HT7510_038sp"

PARAM$exp_input <- "TS7410_038sp"
...
PARAM$bo_lgb <- makeParamSet(
  ...
  makeIntegerParam("num_iterations", lower = 1000L, upper = 2000L)
)


# si usted es ambicioso, y tiene paciencia, podria subir este valor a 100
PARAM$bo_iteraciones <- 90 # iteraciones de la Optimizacion Bayesiana
