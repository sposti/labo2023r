...
PARAM <- list()
PARAM$experimento <- "HT7510_026sp"

PARAM$exp_input <- "TS7410_026sp"
...
#  verbosity = -100,
#  max_depth = 6.0, #-1L, # -1 significa no limitar,  por ahora lo dejo fijo
...
# Hiperparametros FIJOS de  lightgbm## SP
PARAM$lgb_basicos <- list(
  boosting = "gbdt",
  objective = "binary",
  metric = "custom",
  ...
  pos_bagging_fraction = 0.85,
  neg_bagging_fraction = 0.85,
  is_unbalance = FALSE,
...
PARAM$bo_lgb <- makeParamSet(
    makeNumericParam("feature_fraction", lower = 0.2, upper = 0.66)
)
