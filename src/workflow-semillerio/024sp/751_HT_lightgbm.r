...
PARAM <- list()
PARAM$experimento <- "HT7510_024sp"

PARAM$exp_input <- "TS7410_024sp"
...
PARAM$lgb_basicos <- list(
  ...
  min_gain_to_split = 2.55, # min_gain_to_split >= 0.0
  min_sum_hessian_in_leaf = 0.001, #  min_sum_hessian_in_leaf >= 0.0
  lambda_l1 = 16.30709711, # lambda_l1 >= 0.0
  lambda_l2 = 135.6088626, # lambda_l2 >= 0.0
  max_bin = 31L, # lo debo dejar fijo, no participa de la BO
  num_iterations = 2986, # un numero muy grande, lo limita early_stopping_rounds
  ...
  learning_rate = 0.052882274,
  feature_fraction = 0.230085324,
  num_leaves = 777,
  min_data_in_leaf = 5621
...
PARAM$bo_lgb <- makeParamSet(
  ...
  #makeNumericParam("min_gain_to_split", lower = 0.01, upper = 10.0)
)
